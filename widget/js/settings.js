...
define([
    ...
    return function (_$modal_body, _widget, _templater, _logger, _config) {
        ...
        this.prepareModal = function (ctx) {
            _$modal_body.find('.widget_settings_block__item_field:last').
        ...
        this.renderFieldsMapping = function (ctx) {
            ...
            if (amoFields) {
                ...
                _templater.render('fields_mapping', function (template, base_params) {
                    ctx.$mappingWrapper.html(template.render($.extend({}, base_params, templateParams, {})));
        ...
        this.save = function () {
            ...
            const $checkedInputs = $(`.nika-${_config.widget.name}-settings-wrapper input:checked`, _$modal_body);
            let storage = [];
